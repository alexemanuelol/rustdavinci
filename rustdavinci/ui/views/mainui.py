...
class Ui_MainUI(object):
    def setupUi(self, MainUI):
        ...
        self.show_image_PushButton = QtWidgets.QPushButton(self.centralwidget)
        self.show_image_PushButton.setEnabled(False)
        self.show_image_PushButton.setGeometry(QtCore.QRect(10, 350, 221, 41))
        self.show_image_PushButton.setObjectName("show_image_PushButton")
    ...
    def retranslateUi(self, MainUI):
        ...
        self.show_image_PushButton.setText(_translate("MainUI", "Show Image >>"))
