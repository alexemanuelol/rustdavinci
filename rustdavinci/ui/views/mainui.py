...
class Ui_MainUI(object):
    def setupUi(self, MainUI):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../resources/RustDaVinci-icon.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../resources/load_image_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../resources/select_area_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../resources/paint_image_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../resources/settings_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
