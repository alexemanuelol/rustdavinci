...
class Ui_MainUI(object):
    def setupUi(self, MainUI):
        ...
        self.load_image_PushButton.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.load_image_PushButton.setInputMethodHints(QtCore.Qt.ImhNone)
        icon1 = QtGui.QIcon()
        ...
        self.paint_image_PushButton.setInputMethodHints(QtCore.Qt.ImhNone)
        icon3 = QtGui.QIcon()
