...
class Ui_SettingsUI(object):
    def setupUi(self, SettingsUI):
        ...
        self.line_1.setGeometry(QtCore.QRect(10, 80, 351, 20))
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 140, 161, 20))
        self.label_4.setObjectName("label_4")
        self.label_7 = QtWidgets.QLabel(self.generalTab)
        self.label_7.setGeometry(QtCore.QRect(300, 120, 51, 20))
        self.label_7.setObjectName("label_7")
        self.label_9 = QtWidgets.QLabel(self.generalTab)
        self.label_9.setGeometry(QtCore.QRect(300, 160, 51, 20))
        self.label_9.setObjectName("label_9")
        self.controlAreaYLineEdit = QtWidgets.QLineEdit(self.generalTab)
        self.controlAreaYLineEdit.setGeometry(QtCore.QRect(180, 120, 101, 20))
        ...
        self.clearCoordinatesPushButton.setGeometry(QtCore.QRect(180, 180, 101, 23))
        ...
        self.controlAreaHeightLineEdit.setGeometry(QtCore.QRect(180, 160, 101, 20))
        ...
        self.controlAreaWidthLineEdit.setGeometry(QtCore.QRect(180, 140, 101, 20))
        ...
        self.label_6.setGeometry(QtCore.QRect(300, 100, 51, 20))
        self.label_6.setObjectName("label_6")
        self.controlAreaXLineEdit = QtWidgets.QLineEdit(self.generalTab)
        self.controlAreaXLineEdit.setGeometry(QtCore.QRect(180, 100, 101, 20))
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 120, 161, 20))
        self.label_3.setObjectName("label_3")
        self.setTopmostPaintingCheckBox = QtWidgets.QCheckBox(self.generalTab)
        self.setTopmostPaintingCheckBox.setGeometry(QtCore.QRect(20, 50, 341, 17))
        self.setTopmostPaintingCheckBox.setChecked(True)
        self.setTopmostPaintingCheckBox.setObjectName("setTopmostPaintingCheckBox")
        self.line_7 = QtWidgets.QFrame(self.generalTab)
        self.line_7.setGeometry(QtCore.QRect(10, 200, 351, 20))
        self.line_7.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_7.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_7.setObjectName("line_7")
        self.skipDefaultColorCheckBox = QtWidgets.QCheckBox(self.generalTab)
        self.skipDefaultColorCheckBox.setGeometry(QtCore.QRect(20, 230, 341, 17))
        ...
        self.label_13.setGeometry(QtCore.QRect(20, 260, 161, 21))
        self.label_13.setObjectName("label_13")
        self.colorPickerPushButton = QtWidgets.QPushButton(self.generalTab)
        self.colorPickerPushButton.setGeometry(QtCore.QRect(320, 260, 31, 20))
        self.colorPickerPushButton.setObjectName("colorPickerPushButton")
        self.backgroundColorLineEdit = QtWidgets.QLineEdit(self.generalTab)
        self.backgroundColorLineEdit.setGeometry(QtCore.QRect(180, 260, 131, 20))
        self.backgroundColorLineEdit.setAlignment(QtCore.Qt.AlignCenter)
        self.backgroundColorLineEdit.setReadOnly(True)
        ...
        self.skipColorsListWidget.setGeometry(QtCore.QRect(20, 310, 241, 111))
        self.skipColorsListWidget.setObjectName("skipColorsListWidget")
        self.addSkipColorPushButton = QtWidgets.QPushButton(self.generalTab)
        self.addSkipColorPushButton.setGeometry(QtCore.QRect(270, 310, 81, 23))
        self.addSkipColorPushButton.setObjectName("addSkipColorPushButton")
        self.removeSkipColorPushButton = QtWidgets.QPushButton(self.generalTab)
        self.removeSkipColorPushButton.setGeometry(QtCore.QRect(270, 340, 81, 23))
        self.removeSkipColorPushButton.setObjectName("removeSkipColorPushButton")
        ...
        self.autoUpdateCanvasCheckBox.setGeometry(QtCore.QRect(20, 320, 341, 17))
        ...
        self.autoUpdateCanvasWhenCompletedCheckBox.setGeometry(QtCore.QRect(20, 340, 341, 17))
        ...
        self.useBrushOpacitiesCheckBox.setGeometry(QtCore.QRect(20, 390, 341, 17))
        ...
        self.drawLinesCheckBox.setGeometry(QtCore.QRect(20, 410, 341, 17))
        ...
        self.line_4.setGeometry(QtCore.QRect(10, 360, 351, 20))
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.skipColorsLineEdit = QtWidgets.QLineEdit(self.paintingTab)
        self.skipColorsLineEdit.setGeometry(QtCore.QRect(180, 140, 171, 20))
        self.skipColorsLineEdit.setObjectName("skipColorsLineEdit")
        self.label_47 = QtWidgets.QLabel(self.paintingTab)
        self.label_47.setGeometry(QtCore.QRect(20, 140, 161, 21))
    ...
    def retranslateUi(self, SettingsUI):
        ...
        self.setTopmostPaintingCheckBox.setText(_translate("SettingsUI", "Set the rustDaVinci window on topmost while painting"))
        ...
        self.colorPickerPushButton.setText(_translate("SettingsUI", "..."))
        self.backgroundColorLineEdit.setText(_translate("SettingsUI", "#ECF0F1"))
        self.addSkipColorPushButton.setText(_translate("SettingsUI", "Add"))
        self.removeSkipColorPushButton.setText(_translate("SettingsUI", "Remove"))
        self.label_48.setText(_translate("SettingsUI", "Skip these colors:"))
        ...
        self.cancelKeyLineEdit.setText(_translate("SettingsUI", "esc"))
        ...
        self.label_47.setText(_translate("SettingsUI", "Skip these colors:"))
